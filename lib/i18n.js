...
export const STRINGS = {
  ru: {
    ...
    'album.runhead': 'Альбом дуэли · ЧМ-2026',
    'card.balance': 'Баланс турнира',
    'card.plate.pasha': 'Паша · Чутьё',
    'card.plate.ai': 'AI · Модель v26',
    'card.tag.pasha': 'Бумажная · коллекция «Дуэль»',
    'card.tag.ai': 'Chrome · голографическая фольга',
    'card.ribbon.pasha': 'Чутьё и купоны из чата',
    'card.ribbon.ai': 'XG-модель и холодный расчёт',
    'card.no.pasha': '№ 001',
    'card.no.ai': '№ 002',
    'card.rare': 'редкая',
    'card.series': 'Серия ЧМ-2026',
    'card.hits': 'зашло',
    'vs.md': 'Матчдей №',
    'hand.start': ' — старт у каждого 100 000 ₽',
    'slot.n': 'Слот №',
    'slot.today': 'сегодня',
    'slot.waiting': 'идёт — ждём наклейку',
    'stamp.hit': 'Зашло',
    'stamp.miss': 'Мимо',
    'stamp.live': 'Идёт',
    ...
    'bets.why': 'исходный прогноз',
    'bets.whyPending': 'прогноз',
    ...
    'daycard.staked': 'ставки',
    'daycard.stillIn': 'ещё в игре',

    'legend.odds': 'кф',
    'legend.cap': 'Иконка = надёжность (щит — база · молния — риск · огонь — лотерея). Цвет суммы — результат. Лимит на матч: до 7 500 ₽ в прематче, до 10 000 ₽ с лайвом. Банк у каждого 100 000 ₽.',
  ...
  en: {
    ...
    'album.runhead': 'The Duel Album · WC-2026',
    'card.balance': 'Tournament balance',
    'card.plate.pasha': 'Pasha · Gut feel',
    'card.plate.ai': 'AI · Model v26',
    'card.tag.pasha': 'Paper · “Duel” collection',
    'card.tag.ai': 'Chrome · holo foil',
    'card.ribbon.pasha': 'Gut feel & chat coupons',
    'card.ribbon.ai': 'xG model & cold math',
    'card.no.pasha': '№ 001',
    'card.no.ai': '№ 002',
    'card.rare': 'rare',
    'card.series': 'WC-2026 series',
    'card.hits': 'hit',
    'vs.md': 'Matchday #',
    'hand.start': ' — both started at 100 000 ₽',
    'slot.n': 'Slot #',
    'slot.today': 'today',
    'slot.waiting': 'in play — sticker pending',
    'stamp.hit': 'Hit',
    'stamp.miss': 'Miss',
    'stamp.live': 'Live',
    ...
    'bets.noPick': 'no pick',
    'bets.why': 'original call',
    'bets.whyPending': 'the call',
    ...
    'daycard.staked': 'staked',
    'daycard.stillIn': 'still in play',

    'legend.odds': 'odds',
    'legend.cap': 'Icon = reliability (shield — safe · bolt — risk · flame — lottery). Amount colour = result. Per-match limit: up to ₽7,500 pre-match, up to ₽10,000 with live. Each side starts with ₽100,000.',
