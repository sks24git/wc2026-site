...
const PRED = {
  ...
  M98: { ...P(T('Испания', 'Spain', 'es'), T('Бельгия', 'Belgium', 'be'), 'a', '1:0', 'reg', 'medium'), fact: 'a', fscore: '2:1', fby: 'reg' },
  ...
  // ── Финал + 3-е место ──
  M104: { ...P(T('Испания', 'Spain', 'es'), T('Аргентина', 'Argentina', 'ar'), 'b', '1:1 (3:4 пен)', 'pen', 'tossup'), fact: 'a', fscore: '1:0 (доп. время)', fby: 'aet' },
